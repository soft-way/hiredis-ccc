...
int HIREDIS_EXPORT redisClustervAsyncCommand(redisClusterAsyncContext *acc, redisClusterCallbackFn *fn, void *privdata, const char *format, va_list ap);
int HIREDIS_EXPORT redisClusterAsyncCommand(redisClusterAsyncContext *acc, redisClusterCallbackFn *fn, void *privdata, const char *format, ...);
int HIREDIS_EXPORT redisClusterAsyncCommandArgv(redisClusterAsyncContext *acc, redisClusterCallbackFn *fn, void *privdata, int argc, const char **argv, const size_t *argvlen);
void HIREDIS_EXPORT redisClusterAsyncDisconnect(redisClusterAsyncContext *acc);
void HIREDIS_EXPORT redisClusterAsyncFree(redisClusterAsyncContext *acc);
